...
{
    public class StackedColumnCharts : BaseRenderObject
    {
        ...
        public void SetDefault(bool bIsCreateConfigFile)
        {
            ...
            {
                column = new column() { animation = true, stacking = "normal", pointPadding = 0.1f, borderWidth = 0 }
            };
            ...
            {
                CreateConfigFile("StackedColumnCharts.xml");
            }
        }
    }
}
